...
export class MemberContactsContactFormDialogComponent implements OnDestroy, OnInit
{
    selectedUser: any;
    action: string;
     ...
     * Constructor
     *
     * @param {MatDialogRef<MemberContactsContactFormDialogComponent>} matDialogRef
     * @param _data
     * @param {FormBuilder} _formBuilder
     */
    constructor(
        public matDialogRef: MatDialogRef<MemberContactsContactFormDialogComponent>,
